export default {
  ...
  proxies: {
    ...
    addToGroup: "افزودن به گروه پروکسی",
    removeFromGroup: "حذف از گروه پروکسی",
  ...
  subscription: {
    updateMode: "به‌روزرسانی خودکار اشتراک",
    updateModes: {
      disabled: "غیرفعال",
      onStart: "هنگام شروع سرویس",
      interval: "در بازهٔ زمانی",
      intervalFailsafe: "در بازهٔ زمانی همراه با بازیابی خطا",
    },
    updateModeHelp: {
      disabled: "اشتراک فقط با به‌روزرسانی دستی تغییر می‌کند.",
      onStart:
        "با هر شروع v2rayA و یک بار بلافاصله پس از تغییر نشانی یا سیاست به‌روزرسانی، اشتراک به‌روز می‌شود.",
      interval: "هنگام شروع و سپس در بازهٔ زمانی تعیین‌شده به‌روزرسانی می‌شود.",
      intervalFailsafe:
        "هنگام شروع و در بازهٔ منظم به‌روزرسانی می‌شود. اگر همهٔ سرورهای اشتراک قطع باشند، تا زمان کار کردن یک سرور در بازهٔ خطا دوباره تلاش می‌کند.",
    },
    allowDirectRecovery: "نادیده گرفتن مسیر دریافت اشتراک هنگام بازیابی",
    recoveryRouteHelp:
      "اگر بازیابی از پراکسی تعیین‌شده شکست بخورد، دریافت مستقیم مجاز است. مسیر به‌روزرسانی دستی و منظم تغییر نمی‌کند. تلاش مستقیم گزارش می‌شود و شبکه نشانی سرویس اشتراک را می‌بیند.",
    updateIntervalMinutes: "به‌روزرسانی منظم (دقیقه)",
    regularHelp: "الزامی است. تعداد صحیحی از دقیقه، حداقل ۱، وارد کنید.",
    failureIntervalMinutes: "تلاش پس از خطا (دقیقه)",
    failureHelp:
      "الزامی، حداقل ۱ دقیقه. وقتی همهٔ سرورها قطع هستند به‌روز می‌کند؛ با اتصال یک سرور تکرار متوقف می‌شود.",
    intervalInvalid: "عددی صحیح از {minimum} تا 525600 وارد کنید.",
  ...
  operations: {
    ...
    copyLink: "کپی پیوند",
    export: "خروجی گرفتن",
    exportClipboard: "خروجی به کلیپ‌بورد",
    exportTxt: "خروجی به فایل TXT",
    exportSaved: "{file} ذخیره شد",
  ...
  setting: {
    ...
    messages: {
      ...
      tproxyExcludedInterfaces:
        "پیشوندهای رابط‌های شبکه‌ای را تعیین کنید که نباید از پروکسی شفاف عبور کنند. از نویسه‌گردان * پشتیبانی می‌شود (در حالت iptables به‌صورت خودکار به + تبدیل می‌شود). برای نمونه: docker*، veth*، wg*، ppp*. برای جداسازی چند پیشوند از ویرگول استفاده کنید. در OpenWrt، ترافیک پل‌های LAN به‌طور پیش‌فرض از پروکسی عبور می‌کند؛ افزودن br-* در اینجا آن‌ها را مستثنا می‌کند.",
      tunAutoRoute:
  ...
  outbound: {
    autoAdd: "افزودن خودکار سرورهای در دسترس",
    autoAddHelp:
      "سرورهای در دسترس را از تمام فهرست پراکسی، شامل همهٔ اشتراک‌ها، در گروه نگه می‌دارد.",
    autoAddDetails:
      "پس از تغییر فهرست و در هر دورهٔ بررسی اجرا می‌شود. اعضای قطع‌شده حذف می‌شوند. گروه خالی ترافیک خود را مسدود می‌کند.",
    ...
    strategy: "راهبرد اتصال",
    strategyHelp:
      "نحوهٔ توزیع اتصال‌های جدید میان اعضای گروه را تعیین می‌کند. اگر هیچ سروری در دسترس نباشد، گروه ترافیک خود را مسدود می‌کند.",
    strategies: {
    ...
    strategyDetails: {
      leastping:
        "پیوسته از نتیجهٔ آزمون‌ها استفاده می‌کند و سرور در دسترس با کمترین تأخیر اندازه‌گیری‌شده را ترجیح می‌دهد.",
      keepcurrent:
        "تا زمانی که سرور فعلی در دسترس است آن را حفظ می‌کند. پس از خرابی، نخستین عضو در دسترس را طبق ترتیب پایدار گروه انتخاب می‌کند. سرور قدیمی پس از بازیابی دوباره ترافیک را تصاحب نمی‌کند.",
      roundrobin:
        "اتصال‌های جدید را به نوبت میان اعضای در دسترس گروه توزیع می‌کند.",
      random:
        "برای هر اتصال جدید یک عضو در دسترس گروه را تصادفی انتخاب می‌کند.",
    },
  },
  proxyGroup: {
