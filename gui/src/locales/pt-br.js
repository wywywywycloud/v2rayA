export default {
  ...
  proxies: {
    ...
    source: "Origem",
    inUse: "Em uso",
    addToGroup: "Adicionar ao grupo de proxy",
    removeFromGroup: "Remover do grupo de proxy",
  ...
  operations: {
    ...
    export: "Exportar",
    exportClipboard: "Exportar para a área de transferência",
    exportTxt: "Exportar para arquivo TXT",
    exportSaved: "{file} exportado",
