...
اگر هیچ سروری در دسترس نباشد، فقط ترافیک همان گروه به خروجی مسدودکننده فرستاده می‌شود. گروه‌های دیگر و مسیرهای مستقیم کار می‌کنند و پراکسی شفاف فعال می‌ماند؛ بنابراین خرابی باعث عبور پنهانی بدون پراکسی نمی‌شود. پس از ارتقا، اگر دست‌کم یک اشتراک از انتخاب خودکار قدیمی استفاده کرده باشد، عضویت خودکار برای گروه `PROXY` فعال می‌شود.
